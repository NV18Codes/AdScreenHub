...
export const ORDER_STATUS = {
  ...
  PENDING_DISPLAY_APPROVAL: 'Pending Display Approval',
...
export const ALL_ORDER_STATUSES = [
  ...
  ORDER_STATUS.PENDING_DISPLAY_APPROVAL,
...
export const STATUS_CATEGORIES = {
  ...
  ACTIVE: [ORDER_STATUS.IN_DISPLAY, ORDER_STATUS.PENDING_DISPLAY_APPROVAL],
  COMPLETED: [ORDER_STATUS.COMPLETED],
  CANCELLED: [ORDER_STATUS.CANCELLED, ORDER_STATUS.CANCELLED_FORFEITED, ORDER_STATUS.CANCELLED_REFUNDED, ORDER_STATUS.PAYMENT_FAILED],
...
export const STATUS_COLORS = {
  ...
  [ORDER_STATUS.PENDING_DISPLAY_APPROVAL]: '#8b5cf6', // purple
