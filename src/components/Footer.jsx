...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/adscreenhub',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/adscreenhub',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/adscreenhub',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'X (Twitter)',
      url: 'https://twitter.com/adscreenhub',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
